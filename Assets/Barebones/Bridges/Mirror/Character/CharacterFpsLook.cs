...
namespace Barebones.Bridges.Mirror.Character
{
    ...
    public class CharacterFpsLook : CharacterBehaviour
    {
        ...
        /// <summary>
        /// The starting parent of the camera. It is necessary in order to return the camera to its original place after the destruction of the current object
        /// </summary>
        private Transform initialCameraParent;

        /// <summary>
        /// The starting position of the camera. It is necessary in order to return the camera to its original place after the destruction of the current object
        /// </summary>
        private Vector3 initialCameraPosition;

        /// <summary>
        /// The starting rotation of the camera. It is necessary in order to return the camera to its original angle after the destruction of the current object
        /// </summary>
        ...
        protected virtual void UpdateCameraPosition()
        {
            ...
            //float lerpedCameraPositionY = Mathf.Lerp(lookCamera.transform.position.y, newCameraPosition.y, Time.fixedDeltaTime * 5f);
            //lookCamera.transform.position = new Vector3(newCameraPosition.x, lerpedCameraPositionY, newCameraPosition.z);
        ...
        {
            cameraRotation.y += inputController.MouseInput.x * lookSensitivity.x;
            cameraRotation.x = Mathf.Clamp(cameraRotation.x - inputController.MouseInput.y * lookSensitivity.y, minLookAngle, maxLookAngle);
